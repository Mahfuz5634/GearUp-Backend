...
router.post("/gear", (0, auth_1.default)("PROVIDER"), upload_1.default.single("image"), (0, validateRequest_1.default)(gear_validation_1.GearValidation.createGearValidationSchema), provider_controller_1.ProviderController.createGear);
router.put("/gear/:id", (0, auth_1.default)("PROVIDER"), upload_1.default.single("image"), (0, validateRequest_1.default)(gear_validation_1.GearValidation.updateGearValidationSchema), provider_controller_1.ProviderController.updateGear);
